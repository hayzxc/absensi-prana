<div class="w-full">
  ...
  <div class="flex flex-col gap-4 md:flex-row">
    @if (!$isAbsence)
      <div class="flex flex-col gap-4">
        <div>
          <div class="mb-5 flex justify-center gap-4">
            <div class="flex items-center">
                <input type="radio" id="attendance_in" wire:model="attendance_type" value="in" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:focus:ring-offset-gray-800">
                <label for="attendance_in" class="ml-2 block text-sm font-medium text-gray-900 dark:text-gray-300">
                    Absen Datang
                </label>
            </div>
            <div class="flex items-center">
                <input type="radio" id="attendance_out" wire:model="attendance_type" value="out" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:focus:ring-offset-gray-800">
                <label for="attendance_out" class="ml-2 block text-sm font-medium text-gray-900 dark:text-gray-300">
                     Absen Pulang
                </label>
            </div>
          </div>
        ...
        <div class="flex justify-center outline outline-gray-100 dark:outline-slate-700" wire:ignore>
          <div id="scanner" class="min-h-72 w-full sm:min-h-96 sm:w-96 rounded-sm outline-dashed outline-slate-500">
          </div>
        </div>
      </div>
    @endif
    <div class="w-full">
      ...
      <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
        <div
