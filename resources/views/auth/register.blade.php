  ...
  <x-authentication-card>
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="mt-4">
        ...
        <x-select id="division" class="mt-1 block w-full" name="division" required>
          <option disabled selected>{{ __('Select Division') }}</option>
          <option value="Teknis">{{ __('Teknis') }}</option>
          <option value="Keuangan">{{ __('Keuangan') }}</option>
          <option value="Sertifikasi">{{ __('Sertifikasi') }}</option>
          <option value="CS/Admin">{{ __('CS/Admin') }}</option>
          <option value="Verifikasi">{{ __('Verifikasi') }}</option>
        </x-select>
      </div>
