...
class ScanComponent extends Component
{
    ...
    public string $attendance_type = 'in';
    ...
    public function scan(string $barcode)
    {
        ...
        if ($this->attendance_type == 'in') {
            if ($existingAttendance) {
                return "Anda sudah melakukan absen masuk hari ini";
            }
            $attendance = $this->createAttendance($barcode);
            $this->successMsg = __('Attendance In Successful');
        } else {
            if (!$existingAttendance) {
                return "Anda belum melakukan absen masuk hari ini";
            }
